...
- 教程指南：系统化、带实践
- 调研论文：学术性、严谨
- 知识学习：系统性学习算法/框架/论文（YOLO、DeepSeek、LangChain等）
...
**交互流程**（开始前配置）：
1. 询问子代理数量：1/2/3/agent决定（默认2个）
2. 询问每节点搜索次数：1/2/3次（默认2次）
3. 询问每次搜索fetch次数：1/2/3次（默认3次）
4. 询问每次搜索保存数量：1/2/3个（默认3个）
